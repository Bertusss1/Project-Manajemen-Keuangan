...
// Kelas turunan dari Pengguna akun biasa
public class AkunBiasa extends Pengguna {
    // Batas maksimum nominal transaksi per transaksi
    public static final double TRANSACTION_LIMIT = 5000000.0;

    // Batas maksimum jumlah transaksi per hari
    public static final int MAX_TRANSACTIONS_PER_DAY = 5;

    // Getter untuk limit transaksi
    public static double getTransactionLimit() {
        return TRANSACTION_LIMIT;
    }

    // Getter untuk max transaksi harian
    ...
    public AkunBiasa(String nama, String email, String password, double saldo,
    ...
    public void tampilkanSaldo() {
        ...
        System.out.println("Tipe Akun: Regular");
